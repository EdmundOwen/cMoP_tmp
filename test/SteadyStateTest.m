...
classdef (SharedTestFixtures={matlab.unittest.fixtures.PathFixture('../dev')}) SteadyStateTest < matlab.unittest.TestCase
    ...
    properties (MethodSetupParameter)
        setup_varargin = {{'clustersize', 1, 'onsitedim', 3, 'J', 0.5, 'Delta', 1.5, 'U', 10.0, 'Omega', 0.4, 'gamma', 0.3, 'L', { @L0, @LMF } }, ...
                          {'gamma', 1.0, 'Omega', 1.0, 'Delta', 0.0, 'clustersize', 1, 'onsitedim', 2, 'L', { @L0 } }, ...
                          {'Delta', 0.6, 'J', 1.0, 'gamma', 1.0, 'Omega', 1.5, 'clustersize', 2, 'onsitedim', 2, 'L', { @L0, @LMF, @LBTSS }}};
        environ_varargin = {{}};
        steady_varargin = {{}};
    end
