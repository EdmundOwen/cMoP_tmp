...
for i = 1:nr
  ...
  decayrate(i) = outputdata{i}{2}(3);
  lineshift(i) = outputdata{i}{2}(2);
end
% plot results
figure(2)
plot(r_array, 2*sqrt(decayrate), r_array, lineshift)
