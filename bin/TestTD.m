...
gamma = 0.0;
Omega = 0.0;
setup_varargin = {'clustersize', 7, 'onsitedim', 2, 'operators', { @L0 }, 'gamma', gamma, 'Omega', Omega};
timeiter_varargin = { 'method', 'heun', 'Nt', 1000, 'dt', 0.01, 'probes', { @SaveDensity, @SaveCorrelation } };
